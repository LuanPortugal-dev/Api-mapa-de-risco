...
function getDistanceFromLatLonInKm(latitude, longitude) {
    ...
    "use strict";
    let deg2rad = function (deg) { return deg * (Math.PI / 180); }, R = 6371, dLat = deg2rad(latitude_start - latitude_end), dLng = deg2rad(longitude_start - longitude_end), a = Math.sin(dLat / 2) * Math.sin(dLat / 2)
...
//# sourceMappingURL=Verification_distance.js.map